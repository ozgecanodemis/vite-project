...
const InfoSection = () => {
    ...
    return (
        <div className=" bg-white dark:bg-gray-900 transition-colors duration-300">
            ...
            <div className=" w-[1140px] mx-auto flex items-center justify-between bg-white dark:bg-gray-900 transition-colors duration-300 font-inter  transition-colors duration-300">
                {/* 1. parag. */}
